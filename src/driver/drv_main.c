...
#if ENABLE_DRIVER_MYTHERMO
	//drvdetail:{"name":"MyThermo",
	//drvdetail:"title":"Custom temperature/humidity/battery sender",
	//drvdetail:"descr":"Configures CHT83xx+BATT pins and sends UDP JSON broadcast every 5 seconds on port 34210",
	//drvdetail:"requires":""}
	{ "MyThermo",	MyThermo_Init,	MyThermo_OnEverySecond,	NULL, NULL, NULL, NULL, NULL, false },
#endif
