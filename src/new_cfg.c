...
void CFG_SetDefaultConfig() {
	...
	// Override default names for custom build
	strcpy_safe(g_cfg.longDeviceName, "HSELECTRO", sizeof(g_cfg.longDeviceName));
	strcpy_safe(g_cfg.shortDeviceName, "HSELECTRO", sizeof(g_cfg.shortDeviceName));
	strcpy_safe(g_cfg.mqtt_clientId, g_cfg.shortDeviceName, sizeof(g_cfg.mqtt_clientId));
